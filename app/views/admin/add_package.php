...
<div class="mb-8">
    ...
    <h1 class="text-2xl font-bold text-gray-900 mt-2">Create New Package</h1>
</div>

<div class="bg-white rounded-3xl shadow-sm border border-gray-100 p-8 max-w-2xl">
    <form action="<?php echo URLROOT; ?>/admin/add_package" method="POST" class="space-y-6">
        ...
        <div class="pt-6 border-t border-gray-100">
            ...
            <div id="features-container" class="space-y-3">
                <div class="flex gap-2">
                    <input type="text" name="features[]" placeholder="e.g. Unlimited Messages"
